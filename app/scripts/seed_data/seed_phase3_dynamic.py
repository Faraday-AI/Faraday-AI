...
def get_record_count_for_table(table_name: str) -> int:
    ...
    counts = {
        ...
        'fitness_goals': 4000,
        'fitness_goal_progress_detailed': 4000,
        'fitness_goal_progress_general': 4000,
        'health_fitness_goals': 4000,
        'health_fitness_goal_progress': 4000,
        'health_fitness_health_alerts': 1000,
        'health_fitness_health_checks': 1000,
        'health_fitness_health_conditions': 1000,
        'health_fitness_metric_thresholds': 1000,
        'health_fitness_progress_notes': 1000,
        'student_health_fitness_goals': 4000,
        'student_health_goal_progress': 4000,
        'student_health_goal_recommendations': 4000,
        'nutrition_goals': 1000,
        'nutrition_logs': 1000,
        'nutrition_recommendations': 1000,
        'nutrition_education': 1000,
        'nutrition_plans': 1000,
        'foods': 50,
        'food_items': 50,
        'meals': 200,
        'meal_plans': 500,
        'meal_food_items': 1000,
        'physical_education_meals': 200,
        'physical_education_meal_foods': 750,
        'physical_education_nutrition_education': 1000,
        'physical_education_nutrition_goals': 1000,
        'physical_education_nutrition_logs': 1000,
        'physical_education_nutrition_plans': 1000,
        'physical_education_nutrition_recommendations': 1000
    }
