...
class HealthMetricsTrainer:
    ...
    def train_model(
        ...
        return {
            ...
            'model_path': '/app/models/health_metrics.h5'
        }
    ...
    def save_model(self):
        ...
        # Save model
        self.model.save('/app/app/models/health_metrics.keras', save_format='keras')
        
        # Save scaler
        joblib.dump(self.scaler, '/app/app/models/health_metrics_scaler.joblib')
        ...
        with open('/app/app/models/health_metrics_metadata.json', 'w') as f:
