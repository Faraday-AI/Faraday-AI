...
def setup_student_relationships(Student):
    ...
    Student.activity_preferences = relationship("app.models.physical_education.activity.models.StudentActivityPreference", back_populates="student", cascade="all, delete-orphan", overlaps="student,activity_preferences")
    ...
    Student.health_metrics = relationship("HealthMetric", back_populates="student", cascade="all, delete-orphan", overlaps="student,health_metrics")
    Student.health_metric_history = relationship("HealthMetricHistory", back_populates="student", cascade="all, delete-orphan", overlaps="student,health_metric_history")
