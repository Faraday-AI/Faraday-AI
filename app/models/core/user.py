...
class User(CoreBase, TimestampedMixin, StatusMixin, MetadataMixin):
    ...
    conducted_risk_assessments = relationship("RiskAssessment", back_populates="assessor", lazy="select")
    conducted_checks = relationship("SafetyCheck", back_populates="checker", foreign_keys="[SafetyCheck.checked_by]", lazy="select")
    conducted_environmental_checks = relationship("EnvironmentalCheck", back_populates="checker", lazy="select")
    reviewed_protocols = relationship("SafetyProtocol", back_populates="reviewer", foreign_keys="[SafetyProtocol.reviewed_by]", lazy="select")
    created_alerts = relationship("SafetyAlert", back_populates="creator", lazy="select")
    created_protocols = relationship("SafetyProtocol", back_populates="creator", foreign_keys="[SafetyProtocol.created_by]", lazy="select")
    performed_checks = relationship("SafetyCheck", back_populates="performer", foreign_keys="[SafetyCheck.performed_by]", lazy="select")
    ...
    resource_usage = relationship("app.models.resource_management.resource_management.ResourceUsage", back_populates="user", lazy="select")
    resource_thresholds = relationship("app.models.resource_management.resource_management.ResourceThreshold", back_populates="user", lazy="select")
    resource_optimization_thresholds = relationship("app.models.resource_management.optimization.models.ResourceOptimizationThreshold", back_populates="user", lazy="select")
    resource_optimizations = relationship("app.models.resource_management.resource_management.ResourceOptimization", back_populates="user", lazy="select")
    resource_optimization_recommendations = relationship("app.models.resource_management.optimization.models.ResourceOptimizationRecommendation", back_populates="user", lazy="select")
    optimization_events = relationship("app.models.resource_management.resource_management.OptimizationEvent", back_populates="user", lazy="select")
    resource_optimization_events = relationship("app.models.resource_management.optimization.models.ResourceOptimizationEvent", back_populates="user", lazy="select")
    resource_events = relationship("ResourceEvent", back_populates="user", lazy="select", overlaps="user")
    resource_alerts = relationship("ResourceAlert", back_populates="user", lazy="select", overlaps="user")
    owned_resources = relationship("app.models.resource_management.resource_management.ResourceSharing", foreign_keys="[app.models.resource_management.resource_management.ResourceSharing.owner_id]", back_populates="owner", lazy="select")
    shared_resources = relationship("app.models.resource_management.resource_management.ResourceSharing", foreign_keys="[app.models.resource_management.resource_management.ResourceSharing.shared_with_user_id]", back_populates="shared_with_user", lazy="select")
    ...
    projects = relationship("app.models.organization.projects.project_management.OrganizationProject", back_populates="user", lazy="select", viewonly=True)
    organization_projects = relationship("app.models.organization.projects.project_management.OrganizationProject", back_populates="user", lazy="select")
