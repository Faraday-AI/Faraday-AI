...
router.include_router(beta_avatars_voices.router, prefix="/api/v1")
...
# Text-to-speech router - Azure TTS for voice samples
router.include_router(text_to_speech.router, prefix="/api/v1", tags=["text-to-speech"])
